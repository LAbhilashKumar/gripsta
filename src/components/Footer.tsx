  ...
  return (
    <footer className="bg-[#0f0f0f] border-t border-border mt-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/dealer" className="hover:text-primary">Dealer</Link></li>
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <a href="https://wa.me/919999999999" target="_blank" rel="noreferrer" className="w-10 h-10 border border-border flex items-center justify-center hover:border-primary hover:text-primary transition-colors" aria-label="WhatsApp">
      ...
      <div className="border-t border-border py-6 text-center text-xs text-muted-foreground">
        Where Innovation Meets Durability™ · © 2026 Gripsta. All rights reserved.
      </div>
    </footer>
  );
}
