...
//                 <a href="mailto:Navpadhhardware@gmail.com" className="hover:text-primary transition-colors">Navpadhhardware@gmail.com</a>
//               </div>
//               <div className="flex gap-3 items-start">
//                 <span className="text-primary mt-0.5">📍</span>
...
//                   <div className="flex items-start justify-between">
//                     {c.img ? (
//                       <div className="w-16 h-16 mb-6 rounded-md overflow-hidden border border-border">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-5">
            {applications.map((a, i) => (
              <Reveal key={a.name} delay={i * 50}>
                <div className="relative aspect-[4/3] border border-border overflow-hidden group cursor-pointer">
                  <img
                    src={a.img}
                    alt={a.name}
