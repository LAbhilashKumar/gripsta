...
//     name: "", phone: "", email: "", subject: "Product suggestion", message: "",
//   });
...
//             <span className="label-accent block mt-4">Phone</span>
//             <a href="tel:+917995955787" className="font-display text-2xl mt-1 block hover:text-primary transition-colors">
//               +91 79959 55787
//             </a>
//           </div>
//           <div className="bg-surface border border-border p-8">
...
//           <div className="bg-surface border border-border p-8">
//             <div className="text-3xl">📍</div>
//             <span className="label-accent block mt-4">Address</span>
//             <p className="font-display text-xl mt-1 leading-snug">
//               Aghapura, Backside of Mahalaksmi Tiffin Center, Hyderabad 500001
//             </p>
//           </div>
//         </div>
...
//             <a href="https://instagram.com/gripsta_1401" target="_blank" rel="noreferrer"
//               className="block font-display text-2xl mt-1 hover:text-primary transition-colors">
//               @gripsta_1401
//             </a>
//           </div>
//         </div>
...
//             <span className="inline-flex items-center gap-2 mt-8 font-bold uppercase tracking-widest border-2 border-white px-8 py-4">
//               Open WhatsApp →
//             </span>
//           </a>
//         </div>
...
//             Have a product suggestion, feedback, or a question? We'd love to hear from you — every message is read by our team.
//           </p>
...
//                   className="w-full bg-surface border border-border px-4 py-3 focus:outline-none focus:border-primary placeholder:text-muted-foreground/40 resize-none" />
//               </div>
...
function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = encodeURIComponent(
      `Hi Gripsta! I have a message for you:\n\n` +
      `Name: ${form.name}\n` +
      `Phone: ${form.phone}\n` +
      `Email: ${form.email}\n` +
      `Type: ${form.subject}\n\n` +
    ...
    <>
      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-6 lg:px-10">
          ...
          <h2 className="font-display text-4xl mt-3">SHARE YOUR THOUGHTS</h2>
          <p className="mt-3 text-muted-foreground text-sm leading-relaxed">
            Have a product suggestion, feedback, or a question? Fill the form below and it'll open WhatsApp with your message pre-filled — just hit send.
          </p>

          {sent ? (
            <div className="mt-10 bg-surface border border-primary/30 p-10 text-center">
              <div className="text-5xl">💬</div>
              <h3 className="font-display text-2xl mt-4">WHATSAPP OPENED</h3>
              <p className="text-muted-foreground mt-2">Your message is pre-filled — just hit send on WhatsApp.</p>
              <button
                onClick={() => setSent(false)}
                className="mt-6 btn-outline text-xs px-6 py-2"
              >
                Send Another →
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-10 space-y-5">
              ...
              <button className="w-full bg-whatsapp text-white py-4 font-semibold uppercase tracking-widest hover:bg-whatsapp-dark transition-colors flex items-center justify-center gap-2">
